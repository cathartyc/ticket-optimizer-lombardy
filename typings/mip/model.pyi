...
class Model:
    ...
    Examples:
        ...
        True
    """
    def __init__(self: Model, name: str = ..., sense: str = ..., solver_name: str = ..., solver: Optional[mip.Solver] = ...) -> None:
        """Model constructor
    ...
    def add_var(self: Model, name: str = ..., lb: numbers.Real = ..., ub: numbers.Real = ..., obj: numbers.Real = ..., var_type: str = ..., column: mip.Column = ...) -> mip.Var:
    ...
    def add_var_tensor(self: Model, shape: Tuple[int, ...], name: str, **kwargs) -> mip.LinExprTensor:
    ...
    def add_constr(self: Model, lin_expr: mip.LinExpr, name: str = ..., priority: mip.constants.ConstraintPriority = ...) -> mip.Constr:
    ...
    def add_lazy_constr(self: Model, expr: mip.LinExpr): # -> None:
    ...
    def add_sos(self: Model, sos: List[Tuple[mip.Var, numbers.Real]], sos_type: int): # -> None:
    ...
    @objective.setter
    def objective(self: Model, objective: Union[numbers.Real, mip.Var, mip.LinExpr, mip.LinExprTensor]): # -> None:
        ...
    ...
    def cuts_generator(self: Model, cuts_generator: Optional[mip.ConstrsGenerator]): # -> None:
        ...
    ...
    def lazy_constrs_generator(self: Model, lazy_constrs_generator: Optional[mip.ConstrsGenerator]): # -> None:
        ...
    ...
    @start.setter
    def start(self: Model, start: Optional[List[Tuple[mip.Var, numbers.Real]]]): # -> None:
        ...
    ...
    def add_cut(self: Model, cut: mip.LinExpr): # -> None:
    ...
    def remove(self: Model, objects: Union[mip.Var, mip.Constr, List[Union[mip.Var, mip.Constr]]]): # -> None:
...
quicksum = ...
def save_mipstart(sol: List[Tuple[mip.Var, numbers.Real]], file_name: str, obj=...): # -> None:
