...
class LinExpr:
    ...
    def add_expr(self, expr: LinExpr, coeff: numbers.Real = ...): # -> None:
    ...
    def add_term(self, term: Union[mip.Var, mip.LinExpr, numbers.Real], coeff: numbers.Real = ...): # -> None:
    ...
    def add_var(self, var: mip.Var, coeff: numbers.Real = ...): # -> None:
    ...
    def set_expr(self: LinExpr, expr: Dict[mip.Var, numbers.Real]): # -> None:
...
class Constr:
    ...
    @priority.setter
    def priority(self, priority: mip.constants.ConstraintPriority): # -> None:
        ...
